	...
	foreach ($context['languages'] as $id_lang => $lang)
	{
		echo '
						<fieldset class="custom_note hide" id="fs_', $id_lang, '">
							<legend><span class="flag_', $id_lang, '"></span> <a href="#" onclick="$(\'#fs_', $id_lang, '\').hide(); $(\'#fs_', $id_lang, '_link\').show(); return false;">', $lang['name'], '</a> <div class="foldable fold"></div></legend>
							<dl class="settings">
								<dt>', $txt['notification_subject'], '</dt>
						...
						<div id="fs_', $id_lang, '_link" class="custom_note hide"><span class="flag_', $id_lang, '"></span> <a href="#" onclick="$(\'#fs_', $id_lang, '\').show(); $(\'#fs_', $id_lang, '_link\').hide(); return false;">', $lang['name'], '</a> <div class="foldable"></div></div>';
	}
