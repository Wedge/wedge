...
function template_new_group()
{
		...
		<form action="<URL>?action=admin;area=membergroups;sa=add" method="post" accept-charset="UTF-8" id="groupForm">
			...
			<div class="windowbg2 wrc">
				<dl class="settings">
					...
					<dd>
						<input name="group_name" id="group_name_input" size="30">
					</dd>';
	...
	if ($context['post_group'] || $context['undefined_group'])
		echo '
					...
					<dd>
						<input name="min_posts" id="min_posts_input" size="5">
					</dd>';
...
function template_edit_group()
{
		...
		<form action="<URL>?action=admin;area=membergroups;sa=edit;group=', $context['group']['id'], '" method="post" accept-charset="UTF-8" name="groupForm" id="groupForm">
			...
			<div class="windowbg2 wrc">
				<dl class="settings">
					...
					<dd>
						<input name="group_name" id="group_name_input" value="', $context['group']['editable_name'], '" size="30">
					</dd>';
	...
	if ($context['group']['id'] != 3 && $context['group']['id'] != 4)
		echo '
					...
					<dd>
						<input name="group_moderators" id="group_moderators" value="', $context['group']['moderator_list'], '" size="30">
					</dd>
	...
	if ($context['group']['allow_post_group'])
		echo '
					...
					<dd>
						<input name="min_posts" id="min_posts_input"', $context['group']['is_post_group'] ? ' value="' . $context['group']['min_posts'] . '"' : '', ' size="6">
					</dd>';
	...
	echo '
					...
					<dd>
						<input name="star_count" id="star_count_input" value="', $context['group']['star_count'], '" size="4" onkeyup="if (this.value.length > 2) this.value = 99;" onkeydown="this.onkeyup();" onchange="if (this.value != 0) this.form.star_image.onchange();">
					</dd>
					<dt>
					...
					<dd>
						<input name="max_messages" id="max_messages_input" value="', $context['group']['id'] == 1 ? 0 : $context['group']['max_messages'], '" size="6"', $context['group']['id'] == 1 ? ' disabled' : '', '>
					</dd>';
...
function template_group_members()
{
	...
	echo '
			...
			<table class="table_grid w100 cs0">
				<thead>
					<tr class="catbg">
						<th><a href="<URL>?action=', $context['current_action'], (isset($context['admin_area']) ? ';area=' . $context['admin_area'] : ''), ';sa=members;start=', $context['start'], ';sort=name', $context['sort_by'] == 'name' && $context['sort_direction'] == 'up' ? ';desc' : '', ';group=', $context['group']['id'], '">', $txt['name'], $context['sort_by'] == 'name' ? ' <span class="sort_' . $context['sort_direction'] . '"></span>' : '', '</a></th>
						<th><a href="<URL>?action=', $context['current_action'], (isset($context['admin_area']) ? ';area=' . $context['admin_area'] : ''), ';sa=members;start=', $context['start'], ';sort=email', $context['sort_by'] == 'email' && $context['sort_direction'] == 'up' ? ';desc' : '', ';group=', $context['group']['id'], '">', $txt['email'], $context['sort_by'] == 'email' ? ' <span class="sort_' . $context['sort_direction'] . '"></span>' : '', '</a></th>
	...
	foreach ($context['group_requests'] as $request)
		echo '
					...
					<dd>
						...
						<textarea name="groupreason[', $request['id'], ']" rows="3" cols="40" style="', we::is('ie8') ? 'width: 635px; max-width: 96%; min-width: 96%' : 'width: 96%', '"></textarea>
					</dd>';
