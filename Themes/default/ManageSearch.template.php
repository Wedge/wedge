			...
			<div class="windowbg wrc">
				<dl class="settings">
					<dt class="large_caption">
						<a href="', $scripturl, '?action=helpadmin;help=search_weight_frequency" onclick="return reqWin(this);" class="help" title="', $txt['help'], '"></a>
					...
					<dt class="large_caption">
						<a href="', $scripturl, '?action=helpadmin;help=search_weight_age" onclick="return reqWin(this);" class="help" title="', $txt['help'], '"></a>
					...
					<dt class="large_caption">
						<a href="', $scripturl, '?action=helpadmin;help=search_weight_length" onclick="return reqWin(this);" class="help" title="', $txt['help'], '"></a>
					...
					<dt class="large_caption">
						<a href="', $scripturl, '?action=helpadmin;help=search_weight_subject" onclick="return reqWin(this);" class="help" title="', $txt['help'], '"></a>
					...
					<dt class="large_caption">
						<a href="', $scripturl, '?action=helpadmin;help=search_weight_first_message" onclick="return reqWin(this);" class="help" title="', $txt['help'], '"></a>
	...
	<div id="admincenter">
		<form action="', $scripturl, '?action=admin;area=managesearch;sa=method" method="post" accept-charset="UTF-8">
			...
			<div class="information">
				<div class="smalltext" style="font-weight: normal;"><a href="', $scripturl, '?action=helpadmin;help=search_why_use_index" onclick="return reqWin(this);">', $txt['search_create_index_why'], '</a></div>
			</div>
			<div class="windowbg wrc">
				<dl class="settings">';
