...
CREATE TABLE {$db_prefix}categories (
	...
	name varchar(255) NOT NULL default '',
	can_collapse bit(1) unsigned NOT NULL default 1,
...
CREATE TABLE {$db_prefix}contacts (
	...
	list_type enum('friends', 'family', 'known', 'work', 'follow', 'restrict', 'custom') NOT NULL default 'friends',
	is_synchronous bit(1) unsigned NOT NULL default 0,
...
CREATE TABLE {$db_prefix}language_changes (
	...
	is_plugin bit(1) unsigned NOT NULL default 0,
...
CREATE TABLE {$db_prefix}mail_queue (
	...
	private bit(1) unsigned NOT NULL default 0,
	PRIMARY KEY (id_mail),
	KEY time_sent (time_sent),
...
CREATE TABLE {$db_prefix}media_albums (
	...
	featured bit(1) unsigned NOT NULL default 0,
	name varchar(255) NOT NULL default '',
	description text NOT NULL,
...
CREATE TABLE {$db_prefix}media_fields (
	...
	options text NOT NULL,
	required bit(1) unsigned NOT NULL default 0,
	searchable bit(1) unsigned NOT NULL default 0,
	description text NOT NULL,
	bbc bit(1) unsigned NOT NULL default 0,
