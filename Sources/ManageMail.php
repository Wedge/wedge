	...
	$listOptions = array(
		...
		'additional_rows' => array(
			array(
				...
				'value' => '[<a href="' . $scripturl . '?action=admin;area=mailqueue;sa=clear;' . $context['session_query'] . '" onclick="return confirm(' . JavaScriptEscape($txt['mailqueue_clear_list_warning']) . ');">' . $txt['mailqueue_clear_list'] . '</a>] <input type="submit" name="delete_redirects" value="' . $txt['delete'] . '" onclick="return confirm(we_confirm);" class="delete">',
			),
		),
	);
