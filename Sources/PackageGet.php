		...
		foreach ($packages as $thisPackage)
		{
			...
			else
			{
				...
				if ($package['description'] == '')
					...
					$package['description'] = parse_bbc(preg_replace('~\[[/]?html\]~i', '', westr::htmlspecialchars($package['description'])), 'plugin-readme');
