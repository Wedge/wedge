	...
	*/
	$permissionList = array(
		'membergroup' => array(
			...
			'media_access' => array(false, 'aeva', 'aeva'),
			'media_moderate' => array(false, 'aeva', 'aeva'),
			'media_manage' => array(false, 'aeva', 'aeva'),
			'media_access_unseen' => array(false, 'aeva', 'aeva'),
			'media_search' => array(false, 'aeva', 'aeva'),
			'media_add_playlists' => array(false, 'aeva', 'aeva'),
			'media_add_user_album' => array(false, 'aeva', 'aeva'),
			'media_auto_approve_albums' => array(false, 'aeva', 'aeva'),
			'media_moderate_own_albums' => array(false, 'aeva', 'aeva'),
			'media_viewprofile' => array(false, 'aeva', 'aeva'),
		),
		'board' => array(
