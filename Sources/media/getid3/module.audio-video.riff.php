			...
			switch ($chunkname) {
				...
				default:
					...
					switch ($chunkname) {
						...
						default:
							if (!preg_match('/^[0-9]{2}(wb|pc|dc|db)$/i', $chunkname) && !empty($LISTchunkParent) && (($RIFFchunk[$chunkname][$thisindex]['offset'] + $RIFFchunk[$chunkname][$thisindex]['size']) <= $LISTchunkMaxOffset)) {
