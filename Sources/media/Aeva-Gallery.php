...
function aeva_initGallery($gal_url = null)
{
	...
	{
		loadSubTemplate(array('aeva_header', 'aeva_subtabs'), array(':top', 'top'), false);
...
function aeva_viewAlbum()
{
	...
	loadSubTemplate('aeva_viewAlbum');
...
function aeva_viewItem()
{
	...
	if (isset($_REQUEST['xml'], $_POST['rating']))
	{
		...
		loadSubTemplate('aeva_xml_rated');
		return true;
	}
	...
	if ($context['browser']['is_ie6'] || $context['browser']['is_ie7'] || $context['browser']['is_iphone'])
		loadSubTemplate('aeva_item_details', array(':side', 'sidebar'));
}
...
function aeva_mgPost()
{
	...
	$context['aeva_form'] = array(
		...
		'file' => array(
			...
			'fieldname' => 'file',
			'type' => 'file',
			'subtext' => $editing ? $txt['media_edit_file_subtext'] : '',
		...
		'embed' => array(
			...
			'fieldname' => 'embed_url',
			'type' => 'text',
			'subtext' => $editing ? $txt['media_embed_sub_edit'] : $txt['media_add_embed_sub'],
