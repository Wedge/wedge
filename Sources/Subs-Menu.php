...
function createMenu($menuData, $menuOptions = array())
{
	...
	*/
	...
	if (!WIRELESS)
	{
		...
		loadSubTemplate($menu_context['template_name'], empty($options['use_sidebar_menu']) ? array(':top', 'top') : array(':side', 'sidebar'), false);
		loadSubTemplate('generic_tabs', array(':top', 'top'), false);
	}
