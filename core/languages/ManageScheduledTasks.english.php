...
$txt['scheduled_tasks_time_offset'] = '<strong>Note:</strong> All times given below are <em>server time</em> and do not take any time offsets setup within Wedge into account.';
...
$txt['scheduled_task_fetchRemoteFiles'] = 'Fetch Wedge remote files';
$txt['scheduled_task_desc_fetchRemoteFiles'] = 'Retrieves JavaScript files from the official website, containing notifications of updates and other information.';
