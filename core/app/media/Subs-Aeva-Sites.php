...
$sites = array(
	...
	array(
		...
		'movie' => '<div class="ytb"><iframe class="aext" src="<PROT>www.youtube-nocookie.com/embed/$2?theme=light" type="text/html" scrolling="no" marginheight="0" marginwidth="0" frameborder="0" allowfullscreen></iframe></div>',
		'ui-height' => 0,
		...
		'fix-html-pattern' => '<object [^>]*><param name="movie" value="<PROT>www\.youtube\.com/v/([\w-]{11})(?:&[^"]*)?">.*?</object>',
	...
	array(
		...
		'movie' => '<div class="ytb"><iframe class="aext" src="<PROT>www.youtube-nocookie.com/embed?listType=playlist&list=PL$2&theme=light" type="text/html" scrolling="no" marginheight="0" marginwidth="0" frameborder="0" allowfullscreen></iframe></div>',
		'ui-height' => 25,
