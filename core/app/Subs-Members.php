...
function registerMember(&$regOptions, $return_errors = false)
{
	...
	if (preg_match('~[<>&"\'=\\\\]~', preg_replace('~&#(?:\d{1,7}|x[0-9a-fA-F]{1,6});~', '', $regOptions['username'])) != 0 || $regOptions['username'] == '_' || $regOptions['username'] == '|' || strhas($regOptions['username'], array('[code', '[/code')))
