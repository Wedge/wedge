		...
		if ($i == 0 && $verify_context['show_visual'])
			echo '
				...
				<div class="smalltext" style="margin: 4px 0 8px 0">
					...
					<input name="', $verify_id, '_vv[code]" value="', !empty($verify_context['text_value']) ? $verify_context['text_value'] : '', '" size="30" tabindex="', $context['tabindex']++, '" required>
				</div>';
		else
		{
			...
			echo '
				<div class="smalltext">
					...
					<input name="', $verify_id, '_vv[q][', $verify_context['questions'][$qIndex]['id'], ']" size="30" value="', $verify_context['questions'][$qIndex]['a'], '"', $verify_context['questions'][$qIndex]['is_error'] ? ' style="border: 1px red solid"' : '', ' tabindex="', $context['tabindex']++, '" required>
				</div>';
		}
